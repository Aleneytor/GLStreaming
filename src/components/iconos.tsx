/**
 * Iconos de la interfaz (trazo, 24×24, Heroicons v2 outline).
 *
 * Por qué existe: la navegación usaba emojis (⚡📦👥💵…) y cada sistema
 * operativo los dibuja distinto — en Windows salen planos y monocromos, en
 * Android/iOS a todo color. Eso rompía la paleta calmada, donde el color solo
 * tiene significado semántico. Un SVG de trazo hereda `currentColor`, así que
 * el icono se pinta con el color del texto que lo acompaña y respeta el tema.
 *
 * Los emojis SÍ se conservan donde son contenido y no interfaz: el mensaje de
 * WhatsApp que se copia para el cliente (`boton-copiar-whatsapp.tsx`) los lleva
 * a propósito, porque ahí sí son parte del texto que se envía.
 */
...
/** Path (o paths) de cada icono, en el viewBox 24×24 de Heroicons. */
const TRAZOS: Record<NombreIcono, string> = {
  // Operaciones: lo urgente del día.
  ...
  // Gastos personales del admin / mis ventas del revendedor: billetera.
  recibo:
  ...
  // Catálogo (configuración del negocio).
  engranaje:
  ...
  // Importar cartera.
  descarga: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3",
  // Contacto del cliente.
  telefono:
    "M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z",
  // Todo en orden (estados vacíos positivos).
...
export function Icono({
  ...
  return (
    <svg
      ...
      className={className}
    >
      {/* Un solo <path>: los trazos son de contorno (sin relleno), así que los
          varios subtrazos «M…» de un mismo icono se dibujan bien juntos. */}
