...
| DEC-65 | Universal+ tiene seis perfiles físicos, pero solo cinco perfiles vendibles. | El sexto perfil no se publica como stock ni como vacancia comercial; la distribución financiera usa cinco unidades vendibles salvo decisión distinta. |
...
| SEC-02 | ¿Qué credenciales puede ver un revendedor en una venta propia? | Nunca contraseña ni costos; PIN/login solo mediante permiso explícito, revelado auditado y jamás en stock libre. |
...
| RES-01 | ¿El revendedor vende directamente o solicita stock? | En el MVP solicita; el administrador aprueba y asigna. |
...
| UNI-01 | En Universal+, ¿el sexto perfil se entrega en venta completa o queda reservado como soporte interno? | Define entrega y capacidad consumida en modalidad completa. |
